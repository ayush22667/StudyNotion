...
function QuizManagementPage() {
  ...
  if (!selectedCourse) {
    return (
      <div className="text-white">
        ...
        <p className="text-richblack-300 mb-6">Select a course to manage quizzes:</p>
        
        {courses.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-richblack-300 text-lg">No courses found.</p>
            <p className="text-richblack-400">Create a course first to manage quizzes.</p>
          </div>
        ) : (
  ...
  return (
    <div>
      ...
      <QuizManagement courseId={selectedCourse._id} />
    </div>
  );
}
